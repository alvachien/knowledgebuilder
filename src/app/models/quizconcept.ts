...
export class Quiz {
  ...
  get ElderSections(): QuizSection[] {
    return this.elderSections;
  }
  get ActiveSection(): QuizSection | null {
    return this.curSection;
  }
  get NextSectionID(): number {
    return this.curSectionID + 1;
  }
...
export class PrimarySchoolMathFAOQuizItem extends PrimarySchoolMathQuizItem {
  protected _leftNumber = 0;
  protected _rightNumber = 0;
...
export class DivisionQuizItem extends PrimarySchoolMathFAOQuizItem {
  ...
  public override IsCorrect(): boolean {
    ...
    if (
      this._inputtedQuotient === null ||
      this._inputtedQuotient === undefined ||
      this._inputtedRemainder === null ||
      this._inputtedRemainder === null
    ) {
      return false;
    }
