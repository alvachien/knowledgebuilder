...
export class ODataService {
  ...
  public getMetadata(forceReload?: boolean): Observable<SafeAny> {
  ...
  // Knowledge items
  //
  public getKnowledgeItems(
    top = 30,
    skip = 0,
    sort?: string,
    order?: string,
    filter?: string
  ): Observable<{ totalCount: number; items: KnowledgeItem[] }> {
  ...
  public readKnowledgeItem(kid: number, forceLoad = false): Observable<KnowledgeItem> {
    ...
    return this.http
      .get(`${this.apiUrl}KnowledgeItems(${kid})`, {
        headers,
        params,
      })
      .pipe(
  ...
  public createKnowledgeItem(ki: KnowledgeItem): Observable<KnowledgeItem> {
    ...
    return this.http
      .post(`${this.apiUrl}KnowledgeItems`, jdata, {
        headers,
        // params,
      })
      .pipe(
  ...
  public changeKnowledgeItem(ki: KnowledgeItem): Observable<KnowledgeItem> {
    ...
    return this.http
      .put(`${this.apiUrl}KnowledgeItems(${ki.ID})`, jdata, {
        headers,
      })
      .pipe(
        map(() => {
  ...
  public deleteKnowledgeItem(itemid: number): Observable<boolean> {
    ...
    return this.http
      .delete(`${this.apiUrl}KnowledgeItems(${itemid})`, {
        headers,
      })
      .pipe(
        map(() => {
  ...
  // Exercise items
  //
  public getExerciseItems(
    top = 30,
    skip = 0,
    sort?: string,
    order?: string,
    filter?: string
  ): Observable<{ totalCount: number; items: ExerciseItem[] }> {
  ...
  public createExerciseItem(qbi: ExerciseItem): Observable<ExerciseItem> {
    ...
    return this.http
      .post(`${this.apiUrl}ExerciseItems`, jdata, {
        headers,
      })
      .pipe(
        map((response) => {
  ...
  public changeExerciseItem(qbi: ExerciseItem): Observable<ExerciseItem> {
    ...
    return this.http
      .put(`${this.apiUrl}ExerciseItems(${qbi.ID})`, jdata, {
        headers,
      })
      .pipe(
        map(() => {
  ...
  public readExerciseItem(qbid: number, forceLoad = false): Observable<ExerciseItem> {
    ...
    return this.http
      .get(`${this.apiUrl}ExerciseItems(${qbid})`, {
        headers,
        params,
      })
      .pipe(
  ...
  public deleteExerciseItem(itemid: number): Observable<boolean> {
    ...
    return this.http
      .delete(`${this.apiUrl}ExerciseItems(${itemid})`, {
        headers,
      })
      .pipe(
        map(() => {
  ...
  public searchExerciseItems(
    top = 30,
    skip = 0,
    filter?: string
  ): Observable<{ totalCount: number; items: ExerciseItemSearchResult[] }> {
    // if (environment.mockdata && this.mockedExerciseItem.length > 0) {
    //   return of({
    //     totalCount: this.mockedExerciseItem.length,
    //     items: this.mockedExerciseItem
  ...
  public createUserCollection(coll: UserCollection): Observable<UserCollection> {
    ...
    return this.http
      .post(`${this.apiUrl}UserCollections`, jdata, {
        headers,
      })
      .pipe(
        map((response) => {
  ...
  public readUserCollection(collid: number, forceLoad = false): Observable<UserCollection> {
    ...
    return this.http
      .get(`${this.apiUrl}UserCollections(${collid})`, {
        headers,
        params,
      })
      .pipe(
  ...
  public addExerciseItemToCollection(collItems: UserCollectionItem[]): Observable<UserCollectionItem[]> {
    ...
    return this.http
      .post(`${this.apiUrl}UserCollectionItems/AddItemToCollectionEx`, jdata, {
        headers,
        params,
      })
      .pipe(
  ...
  public deleteUserCollection(collid: number): Observable<SafeAny> {
    ...
    return this.http
      .delete(`${this.apiUrl}UserCollections(${collid})`, {
        headers,
      })
      .pipe(
        map(() => true),
  ...
  public getExerciseItemUserScores(
    top = 30,
    skip = 0,
    filter?: string
  ...
  public createExerciseItemUserScore(nscore: ExerciseItemUserScore): Observable<ExerciseItemUserScore> {
    ...
    return this.http
      .post(`${this.apiUrl}ExerciseItemUserScores`, jdata, {
        headers,
      })
      .pipe(
        map((response) => {
  ...
  public deleteExerciseItemUserScore(scoreid: number): Observable<boolean> {
    ...
    return this.http
      .delete(`${this.apiUrl}ExerciseItemUserScores(${scoreid})`, {
        headers,
      })
      .pipe(
        map(() => true),
  ...
  public getLastestExerciseItemUserScore(refid: number): Observable<ExerciseItemUserScore | null> {
    ...
    return this.http
      .post(`${this.apiUrl}ExerciseItemUserScores/LatestUserScore`, jdata, {
        headers,
      })
      .pipe(
        map((response) => {
  ...
  public createUserHabit(grp: UserHabit): Observable<UserHabit> {
    ...
    return this.http
      .post(`${this.apiUrl}UserHabits`, jdata, {
        headers,
      })
      .pipe(
        map((response) => {
  ...
  public deleteUserHabit(rid: number): Observable<boolean> {
    ...
    return this.http
      .delete(`${this.apiUrl}UserHabits(${rid})`, {
        headers,
      })
      .pipe(
        map(() => {
  ...
  public getUserHabitRecordViews(
    top = 30,
    skip = 0,
    sort?: string,
    order?: string,
    filter?: string
  ): Observable<{ totalCount: number; items: UserHabitRecordView[] }> {
    if (!this.authService.isAuthenticated) {
      return of({ totalCount: 0, items: [] });
    }
    let headers: HttpHeaders = new HttpHeaders();
  ...
  public createUserHabitRecord(record: UserHabitRecord): Observable<UserHabitRecord> {
    ...
    return this.http
      .post(`${this.apiUrl}UserHabitRecords`, jdata, {
        headers,
      })
      .pipe(
        map((response) => {
  ...
  public getHabitOpeningPointsByUserDate(usr: string, daysbackto: number): Observable<number> {
    ...
    return this.http
      .post(`${this.apiUrl}UserHabitPointsByUserDates/GetOpeningPoint`, jdata, {
        headers,
      })
      .pipe(
        map((response) => {
  ...
  public getHabitPointsByUserDateReport(filter: string): Observable<UserHabitPointsByUserDate[]> {
    ...
    return this.http
      .get(`${this.apiUrl}UserHabitPointsByUserDates`, {
        headers,
        params,
      })
      .pipe(
  ...
  public getHabitPointsByUserHabitDates(): Observable<UserHabitPointsByUserHabitDate[]> {
    ...
    return this.http
      .get(`${this.apiUrl}UserHabitPointsByUserHabitDates`, {
        headers,
      })
      .pipe(
        map((response) => {
  ...
  public getUserHabitPointReports(filter: string): Observable<UserHabitPointReport[]> {
    ...
    return this.http
      .get(`${this.apiUrl}UserHabitPointReports`, {
        headers,
        params,
      })
      .pipe(
  ...
  public getUserOpeningPointReport(usr: string, daysbackto: number): Observable<number> {
    ...
    return this.http
      .post(`${this.apiUrl}UserHabitPoints/GetOpeningPoint`, jdata, {
        headers,
      })
      .pipe(
        map((response) => {
  ...
  public createHabitPoint(point: UserHabitPoint): Observable<UserHabitPoint> {
    ...
    return this.http
      .post(`${this.apiUrl}UserHabitPoints`, jdata, {
        headers,
      })
      .pipe(
        map((response) => {
  ...
  public getHabitPoints(filter: string): Observable<UserHabitPoint[]> {
    ...
    params = params.append('$filter', filter);
    return this.http
      .get(`${this.apiUrl}UserHabitPoints`, {
        headers,
        params,
      })
      .pipe(
  ...
  public deleteHabitPoint(pid: number): Observable<boolean> {
    ...
    return this.http
      .delete(`${this.apiUrl}UserHabitPoints(${pid})`, {
        headers,
      })
      .pipe(
        map(() => true),
