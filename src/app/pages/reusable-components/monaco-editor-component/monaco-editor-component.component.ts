...
import { DiffEditorOptions, EditorOptions, JoinedEditorOptions, NzEditorMode, OnChangeType, OnTouchedType, SafeAny } from '../monaco-editor-types';
...
@Component({
  ...
  selector: 'ac-monaco-editor',
  //exportAs: 'acRichEditor',
  templateUrl: './monaco-editor-component.component.html',
  styleUrls: ['./monaco-editor-component.component.scss'],
  providers: [
    {
      provide: NG_VALUE_ACCESSOR,
      useExisting: forwardRef(() => MonacoEditorComponentComponent),
      multi: true
    }
  ]
})
export class MonacoEditorComponentComponent implements OnDestroy, AfterViewInit, ControlValueAccessor {
  ...
  constructor(
    private codeEditorService: MonacoEditorService,
    private ngZone: NgZone,
    elementRef: ElementRef,
    private platform: Platform
  ) {
    this.el = elementRef.nativeElement;
    this.el.classList.add('ac-code-editor');
  }
  ...
  registerOnChange(fn: OnChangeType): SafeAny {
    this.onChange = fn;
  }
