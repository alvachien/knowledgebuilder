...
@Component({
  selector: 'khb-highschool-senior-physics',
  templateUrl: './senior-physics.component.html',
  styleUrls: ['./senior-physics.component.scss'],
})
export class SeniorPhysicsComponent {
  ...
  get mdFilePath() {
    return `assets/data/highschool-physics/${this.previewFileName}`;
  }
  ...
  onClick(row: any) {
    this.router.navigate(['high-school', 'display-hsphysics-item', row.file]);
  }
  onStartPreview() {
    this.prvIndex = 0;
