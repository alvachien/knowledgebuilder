...
export class KnowledgeItemAddToCollDialog implements AfterViewInit {
    ...
    constructor(public dialogRef: MatDialogRef<KnowledgeItemAddToCollDialog>,
    ...
    public isItemExistedInColl(coll: UserCollection): boolean {
        return coll.Items.findIndex(item => item.RefID === this.data.knowledgeitemid && item.RefType === TagReferenceType.KnowledgeItem) !== -1;
    }
}
